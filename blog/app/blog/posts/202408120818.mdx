...
<Callout>
    Desription: real time face swap and one-click video deepfake with only a single image\
    🌐 Python｜⭐️ 24,889
</Callout>
#### 簡介
...
<Callout>
    Desription: The most powerful and modular diffusion model GUI, api and backend with a graph/nodes interface.\
    🌐 Python｜⭐️ 47,016
</Callout>
#### 簡介
...
<Callout>
    Desription: MiniCPM-V 2.6: A GPT-4V Level MLLM for Single Image, Multi Image and Video on Your Phone\
    🌐 Python｜⭐️ 10,667
</Callout>
#### 簡介
...
<Callout>
    Desription: The most popular HTML, CSS, and JavaScript framework for developing responsive, mobile first projects on the web.\
